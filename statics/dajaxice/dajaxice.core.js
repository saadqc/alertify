...
var Dajaxice = {
    ...
    register_user_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('Registrations.register_user_form', 'POST', callback_function, argv, custom_settings);
    },

    login_user_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('Registrations.login_user_form', 'POST', callback_function, argv, custom_settings);
    },

    check_forgot_password: function(callback_function, argv, custom_settings){
        return Dajaxice.call('Registrations.check_forgot_password', 'POST', callback_function, argv, custom_settings);
    }
